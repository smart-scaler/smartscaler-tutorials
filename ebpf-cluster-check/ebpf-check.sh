...
kubectl -n ${TEST_EBPF_NAMESPACE} apply -f https://raw.githubusercontent.com/smart-scaler/tools-ebpf-cluster-check/main/check-ebpf-support.yaml
...
kubectl -n ${TEST_EBPF_NAMESPACE} delete -f https://raw.githubusercontent.com/smart-scaler/tools-ebpf-cluster-check/main/check-ebpf-support.yaml 2>&1 > /dev/null
